...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-06-2018 a las 23:50:15
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_A_TABLA_PRODUCTO` (IN `_descripcion` VARCHAR(25), IN `_imagen` TEXT, IN `_precio` DECIMAL(6,2))  INSERT INTO producto(descripcion_prod, imagen, precio_prod, estado)VALUES(_descripcion, _imagen, _precio, 1)$$
