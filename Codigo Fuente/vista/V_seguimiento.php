...
<?php  
	...
	//Fecha en la cual se realizo el pedido
	$fechaOrigen="2018-07-05"; //Obtener, no sé como hacerlo
	//Fecha en la cual se entregara el pedido realizado
	$fechaEntrega = "2018-07-16"; //Obtener, no sé como hacerlo
	$segundosFechaActual = strtotime($fechaActual);
	$segundosFechaEntrega = strtotime($fechaEntrega);
	$segundosFechaOrigen = strtotime($fechaOrigen);
	$segundosFaltantes = $segundosFechaEntrega-$segundosFechaActual;
	$segundosOrigen= $segundosFechaEntrega-$segundosFechaOrigen;
	$diasFaltantes = $segundosFaltantes / 86400;
	$diasTotales=$segundosOrigen/86400;
	$diasTranscurridos=$diasTotales-$diasFaltantes;
	echo "<h2 align=center>Faltan $diasFaltantes dias</h2>";
	...
	{
		$porcentaje=round($diasTranscurridos*100/$diasTotales);		
	}
?>
	<div class="col-md-12">
		<div class="progress">
			<div class="progress-bar progress-bar-striped active" role="progressbar" style="width: <?php echo $porcentaje ?>%" ><?php echo $porcentaje."% completado" ?></div>
	...
	{	
		echo "<h3 align=center>Iniciar sesión para observar el seguimiento</h3>";
	}
	?>
